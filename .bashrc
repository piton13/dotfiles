...
export HISTCONTROL=ignoreboth:erasedups # to remove duplicates from history & ignore duplicates and spaces
...
# alias 'mtp'="cd ~/ctc-car/file-ingestion/file-ingestion"

# The next line updates PATH for the Google Cloud SDK.
if [ -f '/home/igor-luk/google-cloud-sdk/path.bash.inc' ]; then . '/home/igor-luk/google-cloud-sdk/path.bash.inc'; fi
